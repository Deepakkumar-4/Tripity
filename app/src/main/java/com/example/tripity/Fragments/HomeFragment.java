...
public class HomeFragment extends Fragment {
    ...
    RecyclerView featuredArchaeologyRecyclerView;
    RecyclerView popularArchaeologyRecyclerView;
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //we need to create object of ArcheologyPlace to add new structure of
        featuredArchaeologyAdapter = new ArchaeologyPlaceAdapter(getFeaturedArchaeologyPlaces(),getActivity());
        popularArchaeologyAdapter = new ArchaeologyPlaceAdapter(getPopularArchaeologyPlaces(),getActivity());
     ...
     List<ArchaeologyPlace> getFeaturedArchaeologyPlaces() {
        ...
        List<ArchaeologyPlace> featurePlaces = new ArrayList<>();
        featurePlaces.add(new ArchaeologyPlace("Taj Mahal", "Agra", R.drawable.tajmahal,"\n" +
                "\n" +
        ...
        featurePlaces.add(new ArchaeologyPlace("Qutub Minar", "Delhi", R.drawable.qutubminar,"Qutub Minar is a tall minaret located in the Qutub complex in the Mehrauli area of Delhi, India. It was built in the early 13th century by Qutub-ud-din Aibak, the first ruler of the Delhi Sultanate, and his successor Iltutmish. The tower stands at a height of 73 meters (240 feet) and has five distinct stories, each with a projecting balcony.\n" +
                "\n" +
        ...
        featurePlaces.add(new ArchaeologyPlace("Ajanta Caves", "Aurangabad", R.drawable.agentacaves,"The Ajanta Caves are a series of Buddhist rock-cut cave monuments located in the Aurangabad district of the Indian state of Maharashtra. The caves were built in two phases, with the first phase dating back to the 2nd century BCE to the 1st century CE, and the second phase dating back to the 5th century CE.\n" +
         ...
         featurePlaces.add(new ArchaeologyPlace("Khajuraho temples","Chhatarpur", R.drawable.khajuraho_temple,"The Khajuraho Temples are a group of historic Hindu and Jain temples located in Khajuraho, a small town in the Indian state of Madhya Pradesh. These temples are renowned for their stunning architecture, intricate carvings, and explicit sculptures that depict a wide range of erotic and non-erotic themes.\n" +
                 "\n" +
                 "The Khajuraho Temples were built between the 9th and 12th centuries CE by the Chandela dynasty and were dedicated to various Hindu deities, including Shiva, Vishnu, and the Sun God, as well as Jain Tirthankaras. The temples are spread across a 20 square kilometer area and consist of both Hindu and Jain temples, with the largest concentration being Hindu temples.\n" +
                 "\n" +
                 "The Khajuraho Temples are famous for their erotic sculptures, which depict various sexual positions and acts. However, these sculptures only represent a small portion of the overall artwork present in the temples. The majority of the sculptures depict scenes from Hindu mythology, including gods and goddesses, celestial beings, and animals.\n" +
                 "\n" +
                 "The temples of Khajuraho are also notable for their intricate carvings and architectural features, including towering spires, ornate facades, and intricately carved ceilings. The temples are built using sandstone and granite and are arranged in a grid-like pattern.\n" +
                 "\n" +
                 "Today, the Khajuraho Temples are a UNESCO World Heritage site and are one of India's most popular tourist attractions. Visitors come from all over the world to admire the temples' stunning architecture and intricate carvings, and to learn about the rich history and culture of the Chandela dynasty."));
        return featurePlaces;
    }

    List<ArchaeologyPlace> getPopularArchaeologyPlaces() {
        // TODO: Implement logic to retrieve popular archaeological places from a data source
        // For now, return a hardcoded list of sample places
        List<ArchaeologyPlace> popularPlaces = new ArrayList<>();
        popularPlaces.add(new ArchaeologyPlace("Fatehpur Sikri", "Agra", R.drawable.fatehpursikri,"Fatehpur Sikri is a historic fortified city located in the Agra district of Uttar Pradesh in India. The city was founded by Mughal emperor Akbar in the late 16th century and served as his capital for about 14 years before being abandoned due to a shortage of water.\n" +
                "\n" +
        ...
        popularPlaces.add(new ArchaeologyPlace("Hampi", "Karnataka", R.drawable.vijayavittla,"The Vijaya Vittala Temple is a historic temple located in Hampi, Karnataka, India. It is considered one of the most important and impressive temples in Hampi and is known for its stunning architecture and intricate carvings.\n" +
                "\n" +
